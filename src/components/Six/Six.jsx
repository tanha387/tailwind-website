...
import logo from '../../../images/five.png'

export const Six = () => {
  return (
    <div className='max-container grid grid-cols-1 mt-28 md:grid-cols-2 lg:grid:cols-2'>
 <div className='w-full md:w-2/3'>
            <h1 className='text-5xl font-bold my-5'>Generate captoions and easily share across channels</h1>
        ...
        <div className='md:ms- ms-0'>
<img  className="fourth-img" src={logo}/>
        </div>
