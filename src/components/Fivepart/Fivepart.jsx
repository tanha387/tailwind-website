...
export const Fivepart = () => {
  return (
    ...
    <div className='md:ms-28 ms-0'>
    <img src={logo} alt="Description" className="mx-auto h-100 w-2/3 lg:w-1/2 xl:w-2/3  md:w-1/2 lg:w-1/2 xl:w-1/2 mt-4" /> 
    </div>

    <div className='mt-6 w-full md:w-2/3 p-5 md:p-0'>
<h1 className='text-5xl font-bold'>Enhance photos and videos using photo editor tools</h1>
